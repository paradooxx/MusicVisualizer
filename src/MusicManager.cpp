...
// create fmod system and initialize it with a single channel
// configuring fft processing
...
{
	void* data;
	dsp->getParameterData(FMOD_DSP_FFT_SPECTRUMDATA, &data, 0, 0, 0);  // fft data for the audio 
